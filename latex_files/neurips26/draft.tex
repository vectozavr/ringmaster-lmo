...
\end{equation*}
%
\begin{theorem}[Time Complexity]\label{thm:time_complexity}
...
\end{theorem}
\begin{proof}
    The proof follows from \Cref{cor:time_sqrt} and \Cref{thm:iteration_complexity}.
\end{proof}
...
\begin{lemma}[{\citet[Lemma 4.1]{maranjyan2025ringmaster}}]
    ...
    Let $R$ be the delay threshold of \Cref{alg:ringmaster_lmo} or \Cref{alg:ringmasternewstops}.
    The time required to complete any $R$ consecutive iterate updates of \Cref{alg:ringmaster_lmo} or \Cref{alg:ringmasternewstops} is at most
